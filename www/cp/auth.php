...
//echo "INSERT INTO `md_usessions` VALUES('', '$sessid', '$date_n', '1', '$username', '$login_password', '1', '', '".time()."')";exit;
mysql_query("INSERT INTO `md_usessions` VALUES(NULL, '$sessid', '$date_n', '1', '$username', '$login_password', '1', '', '".time()."')", $maindb);
