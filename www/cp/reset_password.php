...
<!doctype html>
    ...
    <head>
         <title>
             <?php echo getconfig_var('adserver_name'); ?> - <?php echo __('LOGIN_RESET_PASSWORD');?>
         </title>
       ...
       <?php endif;?>
            <form action="do_resetpassword.php" method="post" accept-charset="utf-8">
                <div class="login_fields">
                    <div class="field">
                        <label for="email">Email <small><a href="signin.php"><?php echo __('LOGIN_BACK');?></a></small></label>
                        <input type="text" name="md_user" value="" id="email" tabindex="1" placeholder="Email" />
                    </div>
                </div> <!-- .login_fields -->

                <div class="login_actions">
                    <button type="submit" class="btn btn-primary" tabindex="3"><?php echo __('LOGIN_RESET_PASSWORD');?></button>
                </div>
            </form>
        </div> <!-- #login_panel -->
    </div> <!-- #login -->
