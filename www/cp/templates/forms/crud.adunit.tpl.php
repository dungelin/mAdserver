...
<div id="create_adunit" class="widget">
    <div class="widget-header">
        ...
        <h3 class="icon aperture">
        <?php if ($current_action=='create'):?>
            <?php echo __('AD_CREATE');?>
    ...
    <div class="widget-content">
        ...
        <div class="field-group">
            <div class="field">
				...
				<label for="adv_name"><?php echo __('AD_NAME');?></label>
			</div>
		</div> <!-- .field-group -->
        ...
        <div id="zonesize" class="field-group">
            ...
            <div class="field">
				...
				<label for="creative_format"><?php echo __('AD_FORMAT');?></label>
			</div>
            <?php endif; ?>
     ...
     <div id="click_url_div" class="field-group">
         <div class="field">
			 ...
			 <label for="click_url"><?php echo __('AD_CLICK_URL');?></label>
		 </div>
	</div> <!-- .field-group -->
  ...
  <div id="html_div" class="field-group">
      <div class="field">
		  ...
		  <label for="html_body">HTML Body</label><br />
          <input <?php if (isset($editdata['adv_mraid']) && $editdata['adv_mraid']==1){echo 'checked="checked"'; } ?> type="checkbox" name="adv_mraid" id="adv_mraid" value="1" />
          <label for="adv_mraid">This is an MRAID ad</label>
	  </div>
  </div> <!-- .field-group -->
