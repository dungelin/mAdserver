...
<div class="widget">
   ...
   <div id="network_select" style="display:none;" class="field-group">
    ...
    <div class="field-group">
        <div class="field">
            ...
            <a class="tooltip" style="font-size:11px;" href="#" title="A campaign with higher priority will show before a campaign with lower priority. If there are two campaigns with the same priority, traffic will be allocated randomly between these campaigns.">
           Info
           </a>
   ...
   <div class="field-group">
       <div class="field">
           ...
           <a class="tooltip" style="font-size:11px;" href="#" title="You can add either a daily impression cap or a total impression cap to your campaign. This does not make sense for network campaigns, but rather for direct sold and promotional campaigns.">
          Info
          </a>
